    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="px-6 py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl font-semibold hover:shadow-lg smooth-transition flex items-center space-x-2"
        >
              ...
              <div className="flex justify-center mb-8">
                <div className="flex space-x-1 bg-white p-1 rounded-2xl shadow-sm border border-gray-100">
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 flex items-center gap-2 ${(activeTab[selectedPrescription.prescription_id] || 'schedule') === 'schedule'
                  ...
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 flex items-center gap-2 ${activeTab[selectedPrescription.prescription_id] === 'progress'
                      ? 'bg-primary-600 text-white shadow-md'
                      : 'text-gray-500 hover:bg-gray-50'
                      }`}
                  >
                      ...
                      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        <div className="relative w-48 h-48 mb-6">
                          <svg className="w-full h-full transform -rotate-90">
                            ...
                            <circle
                              cx="96" cy="96" r="80"
                              className={`fill-none transition-all duration-1000 ease-out ${stats[selectedPrescription.prescription_id]?.overallPercentage >= 80 ? 'stroke-green-500' :
                          ...
                          {stats[selectedPrescription.prescription_id]?.breakdown?.map((med: any, idx: number) => (
                            <div key={idx} className="group">
                              ...
                              <div className="w-full bg-gray-100 rounded-full h-2.5 overflow-hidden">
                                <div
                                  className={`h-full rounded-full transition-all duration-1000 ease-out relative overflow-hidden ${med.percentage >= 80 ? 'bg-green-500' :
