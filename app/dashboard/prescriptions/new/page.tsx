  ...
  return (
    <div className="space-y-6">
              ...
              {patients
                ...
                .map((patient) => (
                  <button
                    ...
                    className={`w-full p-4 rounded-xl border-2 transition-all text-left ${selectedPatientId === patient.pid
      ...
      <button
        ...
        className="w-full p-6 glass-card rounded-2xl bg-[#4596bf] text-white font-bold text-lg smooth-transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl hover:scale-[1.01] transition-all"
      >
        <Sparkles className="w-6 h-6" />
        <span><TranslatedText>Generate with Dr. Manas AI</TranslatedText></span>
        {!selectedPatientId && <span className="text-sm font-normal opacity-70"><TranslatedText>(Select a patient first)</TranslatedText></span>}
      </button>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex space-x-4">
          <button
            type="submit"
            disabled={loading}
            className="flex-1 px-6 py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl font-semibold hover:shadow-lg smooth-transition disabled:opacity-50"
          >
