...
export default function DoctorAppointmentsPage() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      {/* Compact Header */}
      <div className="mb-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-1"><TranslatedText>Consultation Schedule</TranslatedText></h1>
      ...
      <div className="bg-white p-2 rounded-2xl shadow-sm border border-gray-100 inline-flex space-x-2 flex-wrap">
        {tabs.map((tab) => (
          ...
          >
            ...
            {tab.count > 0 && (
              <span className={`ml-2 px-2 py-0.5 rounded-full text-xs font-black ${activeTab === tab.id ? 'bg-white/20' : 'bg-primary-100 text-primary-600'
                }`}>
                {tab.count}
              </span>
            )}
              ...
              >
                ...
                <div className="relative z-10 p-6 space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-bold border ${apt.status === 'confirmed' ? 'bg-green-50 text-green-700 border-green-200' :
                    ...
                    {activeTab === 'pending' && (
                      <>
                        <button
                          ...
                          className="flex-1 py-2.5 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl font-bold text-sm hover:shadow-lg transition-all flex items-center justify-center space-x-1"
                        >
